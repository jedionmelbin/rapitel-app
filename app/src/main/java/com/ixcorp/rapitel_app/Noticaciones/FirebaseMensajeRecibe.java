...
public class FirebaseMensajeRecibe extends FirebaseMessagingService {
    ...
    private void mostrarNotificacion(String titulo, String mensaje) {
        ...
        //Para que se meustre el mensaje en la parte superior
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this,canal_id)
                .setSmallIcon(R.drawable.icon_cardpedido)
                .setSound(uri)
                .setAutoCancel(true)
    ...
    private RemoteViews getNotificacionPersonalizada(String titulo, String mensaje) {
        ...
        remoteViews.setImageViewResource(R.id.idIcono,R.drawable.icon_cardpedido);
        return remoteViews;
    }
}
